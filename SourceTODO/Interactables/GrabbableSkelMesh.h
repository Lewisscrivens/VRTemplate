...
class NINETOFIVE_API UGrabbableSkelMesh : public USkeletalMeshComponent, public IHandsInterface
{
	GENERATED_BODY()
...
private:
	...
	TArray<AActor*> ignored; /* Ignored actors when doing a sphere trace when distance between hand and physics body becomes too great. */
	FVector originalIntertia;
...
public:
	...
	/* Was this grabbable skeltal mesh recently hit. */
	UFUNCTION(BlueprintCallable)
	bool GetRecentlyHit();
