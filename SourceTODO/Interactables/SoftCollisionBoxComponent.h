 ...
 * NOTE: Usefull for preventing things being forces through collisions due to the handSkel having infinite mass and force as it does not simulate physics. */
UCLASS(ClassGroup = (Custom), config = Engine, editinlinenew, Blueprintable, BlueprintType)
class NINETOFIVE_API USoftCollisionBoxComponent : public UBoxComponent
{
	GENERATED_BODY()
...
private:
	...
	TMap<UPrimitiveComponent*, ECollisionResponse> originalValues;
