...
/* Main slidable actor abstract class without an initialized slidingMesh component. Used to create virtual reality drawers etc. */
/* NOTE: See SlidableStaticMeshActor and SlidableSkeletalMeshActor for fully working classes of this type. */
UCLASS(NotBlueprintable, Abstract)
class NINETOFIVE_API ASlidableActor : public AActor, public IHandsInterface
{
	GENERATED_BODY()
...
private:
	...
	UPrimitiveComponent* targetComponent; /* Target component used to check offset from handRef etc. */
	UPrimitiveComponent* componentToGrab; /* Used for physics grabbing, if there is a different component that requires grabbing. */
