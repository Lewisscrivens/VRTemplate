...
/* Define default friction material to use. */
#define PM_NoFriction FString("/Game/Materials/Physics/PM_Grabbables")
...
UCLASS()
class NINETOFIVE_API AWireSplineActor : public AActor
{
	GENERATED_BODY()
